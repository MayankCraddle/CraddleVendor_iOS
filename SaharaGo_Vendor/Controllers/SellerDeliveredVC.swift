...
class SellerDeliveredVC: UIViewController {
    
    @IBOutlet weak var mainView: UIView!
    @IBOutlet weak var ordersDeliveredTableView: UITableView!
    @IBOutlet weak var emptyView: UIView!
    
    var deliveredOrdersArr = [SellerOrdersStruct]()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // Do any additional setup after loading the view.
        self.ordersDeliveredTableView.register(UINib(nibName: "SellerOrdersCell", bundle: nil), forCellReuseIdentifier: "SellerOrdersCell")
    ...
    func getDeliveredOrders() {
        if Reachability.isConnectedToNetwork() {
            ...
            ServerClass.sharedInstance.getRequestWithUrlParameters(param, path: BASE_URL + PROJECT_URL.VENDOR_GET_DELIVERED_ORDER, successBlock: { (json) in
                ...
                if success == "true"
                {
                    self.deliveredOrdersArr.removeAll()
    ...
    func openActionSheet() {
        ...
        alert.addAction(UIAlertAction(title: "Received", style: .default , handler:{ (UIAlertAction)in
            
        }))
        
        alert.addAction(UIAlertAction(title: "Processing", style: .default , handler:{ (UIAlertAction)in
    ...
    @objc func onClickAcceptBtn(sender: UIButton)
    {
        ...
        let info = self.deliveredOrdersArr[index]
    ...
    @objc func onClickRejectBtn(sender: UIButton)
    {
        let index = sender.tag
        let info = self.deliveredOrdersArr[index]
        self.changeOrderStateApi("Cancelled", orderID: info.orderId)
    }
...
extension SellerDeliveredVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.deliveredOrdersArr.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let info = self.deliveredOrdersArr[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        sellerOrderDetailVC.orderDetailArr = self.deliveredOrdersArr[indexPath.row]
        sellerOrderDetailVC.isFrom = "DeliveredOrder"
